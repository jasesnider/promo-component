import { r as registerInstance, h, g as getAssetPath } from './index-e2f79ebb.js';
...
const PromoComponent = class {
    ...
    render() {
        return (h("div", { id: "header-promo" }, h("div", { class: "image" }, h("img", { src: getAssetPath(`./assets/${this.image}`), "aria-hidden": "true" })), h("div", { class: "tagline-wrapper" }, h("span", { class: "content" }, this.promo ? (this.promo.tagline) : (h("span", { class: "skeleton", style: { width: "100%", height: "2rem" } }))), h("span", { class: "link" }, h("a", { href: "#" }, this.promo ? (this.promo.link) : (h("span", { class: "skeleton", style: { width: "100%", height: "2rem" } }))))), h("div", { class: "count-down" }, this.countdown)));
    }
